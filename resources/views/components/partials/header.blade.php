            ...
            <img src="{{asset("assets/images/user/user-01.png")}}" alt="User"/>
                ...
                >
                    ...
                    <form
                        ...
                        @click="$event.target.submit()"
                        class="flex items-center cursor-pointer gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                    >
                        @csrf
                        <svg
                            class="fill-current"
